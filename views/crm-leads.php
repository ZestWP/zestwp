<div class="wrap">
    <h2>
		<?php _e( _PLUGIN_NAME .' :: '._MENU_LEADS_TITLE); ?> 
    ...
    <thead>
        <tr>
            ...
            <th scope="col" class="width50" style=""><?php _e('name');?></th>
    ...
    <tbody>
        ...
        <tr>
			...
			<div class="row-actions">
				<span class="edit"><a href="admin.php?page=<?php echo $_GET['page']; ?>&amp;id=<?php echo $item->id; ?>">View <?php _e(_MENU_LEADS_TITLE);?></a> | </span>
				<span class="trash"><a href="admin.php?page=<?php echo $_GET['page']; ?>&amp;action=delete&amp;id=<?php echo $item->id; ?>" class="trash">Delete <?php _e(_MENU_LEADS_TITLE);?></a></span>
			</div>
		</td>
