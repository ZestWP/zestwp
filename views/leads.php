...
<div class="wrap">
    ...
    <h2><?php echo _PLUGIN_NAME .' :: '._MENU_RECORD_TITLE; ?> <a href="admin.php?page=<?php echo $_GET['page']; ?>&amp;action=leads_export_csv" class="button orbtr-button">Export CSV</a></h2>
    <br class="clear" />
        ...
        <tr<?php if ($i % 2): ?> class="alternate"<?php endif; ?>>
            <td class="post-title column-email">
                ...
                <div class="row-actions">
                	...
                	<span class="trash"><a href="<?php echo add_query_arg($linkparams, "admin.php?page=orbtrconnect-allleads&amp;action=delete&amp;uid={$lead->id}"); ?>" class="trash delete submitdelete">Delete Lead</a></span>
                </div>
            </td>
