<div class="wrap">
    <h2>
		...
		<a href="admin.php?page=ZestWP-email&id=0" class="add-new-h2"><?php _e('New '._MENU_EMAIL_TITLE);?></a>
	</h2>
    ...
    <tbody>
        ...
        <tr>
			...
			<div class="row-actions">
				<span class="edit"><a href="admin.php?page=<?php echo $_GET['page']; ?>&amp;id=<?php echo $item->id; ?>" title="Edit Orbit">Edit <?php _e('Email');?></a> | </span>
