<div class="wrap">
    <h2>
		...
		<a href="admin.php?page=ZestWP-egroup&id=0" class="add-new-h2"><?php _e('New '._MENU_EMAIL_GROUP_TITLE);?></a>
	</h2>
    ...
    <tbody>
        ...
        <tr>
			...
			<div class="row-actions">
				<span class="edit"><a href="admin.php?page=<?php echo $_GET['page']; ?>&amp;id=<?php echo $item->id; ?>" title="Edit Orbit">Edit <?php _e('List');?></a> | </span>
				<span class="trash"><a href="admin.php?page=<?php echo $_GET['page']; ?>&amp;action=delete&amp;id=<?php echo $item->id; ?>" class="trash">Delete <?php _e('List');?></a></span>
			</div>
		</td>
		<td>
